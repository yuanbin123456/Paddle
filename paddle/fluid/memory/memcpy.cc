...
template <>
void Copy<platform::SWPlace, platform::SWPlace>(platform::SWPlace, void* dst,
                                                  platform::SWPlace,
                                                  const void* src, size_t num) {
  if (UNLIKELY(num == 0)) return;
  std::memcpy(dst, src, num);
...
template <>
void Copy<platform::SWPlace, platform::CPUPlace>(platform::SWPlace, void* dst,
                                                  platform::CPUPlace,
                                                  const void* src, size_t num) {
  if (UNLIKELY(num == 0)) return;
  std::memcpy(dst, src, num);
...
template <>
void Copy<platform::CPUPlace, platform::SWPlace>(platform::CPUPlace, void* dst,
                                                  platform::SWPlace,
                                                  const void* src, size_t num) {
  if (UNLIKELY(num == 0)) return;
  std::memcpy(dst, src, num);
