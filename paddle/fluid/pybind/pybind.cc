...
bool IsCompiledWithSW() {
#ifndef PADDLE_WITH_SW
  return false;
#else
  return true;
#endif
...
PYBIND11_MODULE(core_noavx, m) {
  ...
  py::class_<framework::Tensor>(m, "Tensor", py::buffer_protocol())
      ...
      .def("_alloc_float",
           [](framework::Tensor &self, paddle::platform::SWPlace &place) {
             self.mutable_data<float>(place);
           })
      .def("_alloc_float",
      ...
      .def("set", SetTensorFromPyArray<paddle::platform::SWPlace>,
           py::arg("array"), py::arg("place"), py::arg("zero_copy") = false)
...
All parameter, weight, gradient are variables in Paddle.
  ...
  py::class_<paddle::platform::DeviceContext>(m, "DeviceContext")
      ...
      .def_static("create",
        ...
        .def_static("create",
                  [](paddle::platform::SWPlace& place)
                      -> paddle::platform::DeviceContext* {
#ifndef PADDLE_WITH_SW
             PADDLE_THROW(
                 platform::errors::PermissionDenied(
                 "Cannot use SWPlace in CPU/GPU version, "
                 "Please recompile or reinstall Paddle with SW support."));
#else
                    return new paddle::platform::SWDeviceContext(place);
#endif
                  })
        .def_static("create",
...
//SW
    py::class_<paddle::platform::SWPlace>(m, "SWPlace", R"DOC(
    SWPlace is a descriptor of a device.
    It represents a CPU device on which a tensor will be allocated and a model will run.
    ...
    Examples:
        .. code-block:: python
          ...
          import paddle
          cpu_place = paddle.SWPlace(0)

        )DOC")
      .def(py::init<>())
      .def("_type", &PlaceIndex<platform::SWPlace>)
      .def("_equals", &IsSamePlace<platform::SWPlace, platform::Place>)
      .def("_equals", &IsSamePlace<platform::SWPlace, platform::XPUPlace>)
      .def("_equals", &IsSamePlace<platform::SWPlace, platform::NPUPlace>)
      .def("_equals", &IsSamePlace<platform::SWPlace, platform::CUDAPlace>)
      .def("_equals", &IsSamePlace<platform::SWPlace, platform::CPUPlace>)
      .def("_equals",
           &IsSamePlace<platform::SWPlace, platform::CUDAPinnedPlace>)
      .def("__repr__", string::to_string<const platform::SWPlace &>)
      .def("__str__", string::to_string<const platform::SWPlace &>);  
  ...
  py::class_<platform::Place>(m, "Place")
      ...
      .def("_equals", &IsSamePlace<platform::Place, platform::SWPlace>)
      ...
      .def("is_sw_place",
           [](platform::Place &self) { return platform::is_sw_place(self); })
      .def("is_xpu_place",
      ...
      .def("set_place",
           [](platform::Place &self, const platform::SWPlace &sw_place) {
             self = sw_place;
           })
      .def("set_place",
  ...
  py::class_<OperatorBase>(m, "Operator")
      ...
      .def("run",
           [](OperatorBase &self, const Scope &scope,
              const platform::SWPlace &place) { self.Run(scope, place); })
      .def("run",
           [](OperatorBase &self, const Scope &scope,
  ...
  m.def("is_compiled_with_sw", IsCompiledWithSW);
