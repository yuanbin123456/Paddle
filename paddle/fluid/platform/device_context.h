...
constexpr DeviceType kSW = DeviceType::SW;
...
#ifdef PADDLE_WITH_SW
class SWDeviceContext : public DeviceContext {
 public:
  SWDeviceContext();
  explicit SWDeviceContext(SWPlace place);
...
template <>
struct DefaultDeviceContextType<platform::SWPlace> {
  using TYPE = SWDeviceContext;
};
#endif
