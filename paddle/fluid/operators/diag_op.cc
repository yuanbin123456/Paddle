...
REGISTER_OP_SW_KERNEL(
    diag, ops::DiagKernel<paddle::platform::SWDeviceContext, int>,
    ops::DiagKernel<paddle::platform::SWDeviceContext, float>,
    ops::DiagKernel<paddle::platform::SWDeviceContext, double>,
    ops::DiagKernel<paddle::platform::SWDeviceContext, int64_t>);
