...
REGISTER_OP_SW_KERNEL(
    max_pool2d_with_index,
    ops::MaxPoolWithIndexKernel<paddle::platform::SWDeviceContext, float, int>,
    ops::MaxPoolWithIndexKernel<paddle::platform::SWDeviceContext, double,
                                int>);
REGISTER_OP_SW_KERNEL(
    max_pool2d_with_index_grad,
    ops::MaxPoolWithIndexGradKernel<paddle::platform::SWDeviceContext, float,
                                    int>,
    ops::MaxPoolWithIndexGradKernel<paddle::platform::SWDeviceContext, double,
                                    int>);                                    
