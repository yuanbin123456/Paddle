...
/*REGISTER_OP_SW_KERNEL(
    conv2d, ops::GemmConvKernel<paddle::platform::SWDeviceContext, float>,
    ops::GemmConvKernel<paddle::platform::CPUDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    conv2d_grad,
    ops::GemmConvGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::GemmConvGradKernel<paddle::platform::SWDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    conv2d_grad_grad,
    ops::GemmConvDoubleGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::GemmConvDoubleGradKernel<paddle::platform::SWDeviceContext, double>);*/
...
REGISTER_OP_SW_KERNEL(
    conv2d, ops::GemmConvSWKernel<paddle::platform::SWDeviceContext, float>,
    ops::GemmConvSWKernel<paddle::platform::SWDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    conv2d_grad,
    ops::GemmConvGradSWKernel<paddle::platform::SWDeviceContext, float>,
    ops::GemmConvGradSWKernel<paddle::platform::SWDeviceContext, double>);
