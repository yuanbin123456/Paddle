...
REGISTER_OP_SW_KERNEL(
    softmax, ops::SoftmaxKernel<paddle::platform::SWDeviceContext, float>,
    ops::SoftmaxKernel<paddle::platform::SWDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    softmax_grad,
    ops::SoftmaxGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::SoftmaxGradKernel<paddle::platform::SWDeviceContext, double>);
