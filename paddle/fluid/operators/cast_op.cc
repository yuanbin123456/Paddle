...
using SW = paddle::platform::SWDeviceContext;
...
REGISTER_OP_SW_KERNEL(cast, ops::CastOpKernel<SW, float>,
                       ops::CastOpKernel<SW, double>,
                       ops::CastOpKernel<SW, int>,
                       ops::CastOpKernel<SW, int64_t>,
                       ops::CastOpKernel<SW, bool>,
                       ops::CastOpKernel<SW, uint8_t>,
                       ops::CastOpKernel<SW, paddle::platform::float16>,
                       ops::CastOpKernel<SW, paddle::platform::bfloat16>,
                       ops::CastOpKernel<SW, paddle::platform::complex64>,
                       ops::CastOpKernel<SW, paddle::platform::complex128>);                       
