...
using SWCtx = paddle::platform::SWDeviceContext;
...
REGISTER_OP_SW_KERNEL(cross_entropy, ops::CrossEntropyOpKernel<SWCtx, float>,
                       ops::CrossEntropyOpKernel<SWCtx, double>);
REGISTER_OP_SW_KERNEL(cross_entropy_grad,
                       ops::CrossEntropyGradientOpKernel<SWCtx, float>,
                       ops::CrossEntropyGradientOpKernel<SWCtx, double>);                       
