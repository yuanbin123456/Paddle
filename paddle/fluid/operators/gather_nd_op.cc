...
REGISTER_OP_SW_KERNEL(gather_nd, ops::GatherNdOpSWKernel<float>,
                       ops::GatherNdOpSWKernel<double>,
                       ops::GatherNdOpSWKernel<int64_t>,
                       ops::GatherNdOpSWKernel<int>, ops::GatherNdOpSWKernel<bool>,
                       ops::GatherNdOpSWKernel<uint8_t>);

REGISTER_OP_SW_KERNEL(gather_nd_grad, ops::GatherNdGradOpSWKernel<float>,
                       ops::GatherNdGradOpSWKernel<double>,
                       ops::GatherNdGradOpSWKernel<int64_t>,
                       ops::GatherNdGradOpSWKernel<int>,
                       ops::GatherNdGradOpSWKernel<uint8_t>);
