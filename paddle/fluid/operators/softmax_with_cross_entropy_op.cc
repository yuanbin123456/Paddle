...
REGISTER_OP_SW_KERNEL(softmax_with_cross_entropy,
                       ops::SoftmaxWithCrossEntropySWKernel<float>,
                       ops::SoftmaxWithCrossEntropySWKernel<double>);
REGISTER_OP_SW_KERNEL(softmax_with_cross_entropy_grad,
                       ops::SoftmaxWithCrossEntropyGradSWKernel<float>,
                       ops::SoftmaxWithCrossEntropyGradSWKernel<double>);
