...
#define REGISTER_ACTIVATION_SW_KERNEL(act_type, op_name, functor,        \
                                       grad_functor)                      \
  REGISTER_OP_SW_KERNEL(                                                 \
      act_type, ops::ActivationKernel<paddle::platform::SWDeviceContext, \
                                      ops::functor<float>>,               \
      ops::ActivationKernel<paddle::platform::SWDeviceContext,           \
                            ops::functor<double>>);                       \
  REGISTER_OP_SW_KERNEL(                                                 \
      act_type##_grad,                                                    \
      ops::ActivationGradKernel<paddle::platform::SWDeviceContext,       \
                                ops::grad_functor<float>>,                \
      ops::ActivationGradKernel<paddle::platform::SWDeviceContext,       \
                                ops::grad_functor<double>>);
...
REGISTER_ACTIVATION_SW_KERNEL(relu, Relu, ReluCPUFunctor, ReluGradFunctor);
...
REGISTER_OP_SW_KERNEL(
    relu_grad_grad,
    ops::ActivationDoubleGradKernel<plat::SWDeviceContext,
                                    ops::ReluGradGradFunctor<float>>,
    ops::ActivationDoubleGradKernel<plat::SWDeviceContext,
                                    ops::ReluGradGradFunctor<double>>,
    ops::ActivationDoubleGradKernel<plat::SWDeviceContext,
