...
REGISTER_OP_SW_KERNEL(
    mean, ops::MeanKernel<paddle::platform::SWDeviceContext, float>,
    ops::MeanKernel<paddle::platform::SWDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    mean_grad, ops::MeanGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::MeanGradKernel<paddle::platform::SWDeviceContext, double>);
