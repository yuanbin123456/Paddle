...
REGISTER_OP_SW_KERNEL(
    slice, ops::SliceKernel<paddle::platform::SWDeviceContext, int>,
    ops::SliceKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::SliceKernel<paddle::platform::SWDeviceContext, float>,
    ops::SliceKernel<paddle::platform::SWDeviceContext, double>,
    ops::SliceKernel<paddle::platform::SWDeviceContext,
                     paddle::platform::complex64>,
    ops::SliceKernel<paddle::platform::SWDeviceContext,
                     paddle::platform::complex128>);

REGISTER_OP_SW_KERNEL(
    slice_grad, ops::SliceGradKernel<paddle::platform::SWDeviceContext, int>,
    ops::SliceGradKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::SliceGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::SliceGradKernel<paddle::platform::SWDeviceContext, double>,
    ops::SliceGradKernel<paddle::platform::SWDeviceContext,
                         paddle::platform::complex64>,
    ops::SliceGradKernel<paddle::platform::SWDeviceContext,
                         paddle::platform::complex128>);
