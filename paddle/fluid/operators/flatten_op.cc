...
REGISTER_OP_SW_KERNEL(
    flatten, ops::FlattenKernel<paddle::platform::SWDeviceContext, float>,
    ops::FlattenKernel<paddle::platform::SWDeviceContext, double>,
    ops::FlattenKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::FlattenKernel<paddle::platform::SWDeviceContext, int>,
    ops::FlattenKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::FlattenKernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    flatten_grad,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, double>,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, int>,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::FlattenGradKernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    flatten2, ops::Flatten2Kernel<paddle::platform::SWDeviceContext, float>,
    ops::Flatten2Kernel<paddle::platform::SWDeviceContext, double>,
    ops::Flatten2Kernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::Flatten2Kernel<paddle::platform::SWDeviceContext, int>,
    ops::Flatten2Kernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::Flatten2Kernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    flatten2_grad,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, float>,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, double>,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, int>,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::Flatten2GradKernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    flatten_contiguous_range,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext,
                                      float>,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext,
                                      double>,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext,
                                      uint8_t>,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext, int>,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext,
                                      int8_t>,
    ops::FlattenContiguousRangeKernel<paddle::platform::SWDeviceContext,
                                      int64_t>);
REGISTER_OP_SW_KERNEL(
    flatten_contiguous_range_grad,
    ops::FlattenContiguousRangeGradKernel<paddle::platform::SWDeviceContext,
                                          float>,
    ops::FlattenContiguousRangeGradKernel<paddle::platform::SWDeviceContext,
                                          double>,
    ops::FlattenContiguousRangeGradKernel<paddle::platform::SWDeviceContext,
