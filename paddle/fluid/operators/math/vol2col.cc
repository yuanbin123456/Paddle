 ...
 */
template <class T>
class Vol2ColFunctor<platform::SWDeviceContext, T> {
 public:
 ...
 */
template <class T>
class Col2VolFunctor<platform::SWDeviceContext, T> {
 public:
  void operator()(const platform::SWDeviceContext& context,
...
template class Vol2ColFunctor<platform::SWDeviceContext, float>;
template class Vol2ColFunctor<platform::SWDeviceContext, double>;
template class Col2VolFunctor<platform::SWDeviceContext, float>;
template class Col2VolFunctor<platform::SWDeviceContext, double>;
