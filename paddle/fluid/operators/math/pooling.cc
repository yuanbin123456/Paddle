...
template <typename PoolProcess, typename T>
class Pool2dFunctor<platform::SWDeviceContext, PoolProcess, T> {
 public:
...
#ifdef PADDLE_WITH_SW
template <typename PoolProcess, class T>
class Pool2dGradFunctor<platform::SWDeviceContext, PoolProcess, T> {
 public:
  void operator()(
      const platform::SWDeviceContext& context, const framework::Tensor& input,
      const framework::Tensor& output, const framework::Tensor& output_grad,
      const std::vector<int>& ksize, const std::vector<int>& strides,
      const std::vector<int>& paddings, bool exclusive, bool adaptive,
      framework::Tensor* input_grad, PoolProcess pool_grad_process) {
...
*/
template <class T>
class MaxPool2dGradFunctor<platform::SWDeviceContext, T> {
 public:
  void operator()(
      const platform::SWDeviceContext& context, const framework::Tensor& input,
      const framework::Tensor& output, const framework::Tensor& output_grad,
...
template class MaxPool2dGradFunctor<platform::SWDeviceContext, float>;
template class MaxPool2dGradFunctor<platform::SWDeviceContext, double>;

template class Pool2dFunctor<platform::SWDeviceContext,
                             paddle::operators::math::MaxPool<float>, float>;
template class Pool2dFunctor<platform::SWDeviceContext,
                             paddle::operators::math::AvgPool<float>, float>;
template class Pool2dGradFunctor<platform::SWDeviceContext,
...
#ifdef PADDLE_WITH_SW
template <typename PoolProcess, class T>
class Pool3dFunctor<platform::SWDeviceContext, PoolProcess, T> {
 public:
  void operator()(const platform::SWDeviceContext& context,
                  const framework::Tensor& input, const std::vector<int>& ksize,
                  const std::vector<int>& strides,
...
*/
template <typename PoolProcess, class T>
class Pool3dGradFunctor<platform::SWDeviceContext, PoolProcess, T> {
 public:
  void operator()(
      const platform::SWDeviceContext& context, const framework::Tensor& input,
      const framework::Tensor& output, const framework::Tensor& output_grad,
...
template <class T>
class MaxPool3dGradFunctor<platform::SWDeviceContext, T> {
 public:
  void operator()(
      const platform::SWDeviceContext& context, const framework::Tensor& input,
      const framework::Tensor& output, const framework::Tensor& output_grad,
...
template class MaxPool3dGradFunctor<platform::SWDeviceContext, float>;
template class MaxPool3dGradFunctor<platform::SWDeviceContext, double>;

template class Pool3dFunctor<platform::SWDeviceContext,
                             paddle::operators::math::MaxPool<float>, float>;
template class Pool3dFunctor<platform::SWDeviceContext,
                             paddle::operators::math::AvgPool<float>, float>;
template class Pool3dGradFunctor<platform::SWDeviceContext,
                                 paddle::operators::math::MaxPoolGrad<float>,
                                 float>;
template class Pool3dGradFunctor<platform::SWDeviceContext,
                                 paddle::operators::math::AvgPoolGrad<float>,
...
#ifdef PADDLE_WITH_SW
template <typename T1, typename T2>
class MaxPool2dWithIndexFunctor<platform::SWDeviceContext, T1, T2> {
 public:
  void operator()(const platform::SWDeviceContext& context,
                  const framework::Tensor& input, const std::vector<int>& ksize,
                  const std::vector<int>& strides,
 ...
 */
template <typename T1, typename T2>
class MaxPool2dWithIndexGradFunctor<platform::SWDeviceContext, T1, T2> {
 public:
  void operator()(const platform::SWDeviceContext& context,
                  const framework::Tensor& output_grad,
                  const framework::Tensor& mask, const std::vector<int>& ksize,
...
template class MaxPool2dWithIndexFunctor<platform::SWDeviceContext, float,
                                         int>;
template class MaxPool2dWithIndexGradFunctor<platform::SWDeviceContext, float,
                                             int>;
template class MaxPool2dWithIndexFunctor<platform::SWDeviceContext, double,
                                         int>;
template class MaxPool2dWithIndexGradFunctor<platform::SWDeviceContext, double,
                                             int>;
 ...
 */
template <typename T1, typename T2>
class MaxPool3dWithIndexFunctor<platform::SWDeviceContext, T1, T2> {
 public:
  void operator()(const platform::SWDeviceContext& context,
                  const framework::Tensor& input, const std::vector<int>& ksize,
                  const std::vector<int>& strides,
 ...
 */
template <typename T1, typename T2>
class MaxPool3dWithIndexGradFunctor<platform::SWDeviceContext, T1, T2> {
 public:
  void operator()(const platform::SWDeviceContext& context,
                  const framework::Tensor& output_grad,
                  const framework::Tensor& mask, const std::vector<int>& ksize,
...
template class MaxPool3dWithIndexFunctor<platform::SWDeviceContext, float,
                                         int>;
template class MaxPool3dWithIndexGradFunctor<platform::SWDeviceContext, float,
                                             int>;
template class MaxPool3dWithIndexFunctor<platform::SWDeviceContext, double,
                                         int>;
template class MaxPool3dWithIndexGradFunctor<platform::SWDeviceContext, double,
                                             int>;
#endif                                             
}  // namespace math
}  // namespace operators
