...
template class SoftmaxFunctor<platform::SWDeviceContext, float, true>;
template class SoftmaxFunctor<platform::SWDeviceContext, float, false>;
template class SoftmaxFunctor<platform::SWDeviceContext, double, true>;
template class SoftmaxFunctor<platform::SWDeviceContext, double, false>;
template class SoftmaxGradFunctor<platform::SWDeviceContext, float>;
template class SoftmaxGradFunctor<platform::SWDeviceContext, double>;
