...
REGISTER_OP_SW_KERNEL(
    pool2d, ops::PoolKernel<paddle::platform::SWDeviceContext, float>,
    ops::PoolKernel<paddle::platform::SWDeviceContext, double>);
REGISTER_OP_SW_KERNEL(
    pool2d_grad, ops::PoolGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::PoolGradKernel<paddle::platform::SWDeviceContext, double>);
#endif
