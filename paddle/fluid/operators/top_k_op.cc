...
REGISTER_OP_SW_KERNEL(top_k,
                       ops::TopkKernel<paddle::platform::SWPlace, float>,
                       ops::TopkKernel<paddle::platform::SWPlace, double>);

REGISTER_OP_SW_KERNEL(top_k_grad,
                       ops::TopkGradKernel<paddle::platform::SWPlace, float>,
                       ops::TopkGradKernel<paddle::platform::SWPlace, double>);
