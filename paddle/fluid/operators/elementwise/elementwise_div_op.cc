...
struct SameDimsElemwiseDiv<
  ...
  void operator()(const framework::ExecutionContext &ctx,
                  const framework::Tensor *x, const framework::Tensor *y,
                  framework::Tensor *z) {
    default_elementwise_div<platform::SWDeviceContext, T>(ctx, x, y, z);
  }
};
template <typename T>
struct SameDimsElemwiseDiv<
...
REGISTER_OP_SW_KERNEL(
    elementwise_div,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext, float>,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext, double>,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext, int>,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext,
                              paddle::platform::complex64>,
    ops::ElementwiseDivSWKernel<paddle::platform::SWDeviceContext,
                              paddle::platform::complex128>);
REGISTER_OP_CPU_KERNEL(
...
REGISTER_OP_SW_KERNEL(
    elementwise_div_grad,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext, float>,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext, double>,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext, int>,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext,
                                  paddle::platform::complex64>,
    ops::ElementwiseDivGradSWKernel<paddle::platform::SWDeviceContext,
                                  paddle::platform::complex128>);
...
REGISTER_OP_SW_KERNEL(
    elementwise_div_grad_grad,
    ops::ElementwiseDivDoubleGradSWKernel<paddle::platform::SWDeviceContext,
                                        float>,
    ops::ElementwiseDivDoubleGradSWKernel<paddle::platform::SWDeviceContext,
                                        double>,
    ops::ElementwiseDivDoubleGradSWKernel<paddle::platform::SWDeviceContext,
