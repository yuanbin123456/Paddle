...
REGISTER_OP_SW_KERNEL(
    elementwise_add,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext, float>,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext, double>,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext, int>,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext,
                              paddle::platform::complex64>,
    ops::ElementwiseAddKernel<paddle::platform::SWDeviceContext,
                              paddle::platform::complex128>);
REGISTER_OP_SW_KERNEL(
    elementwise_add_grad,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext, double>,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext, int>,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext, int64_t>,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext,
                                  paddle::platform::complex64>,
    ops::ElementwiseAddGradKernel<paddle::platform::SWDeviceContext,
                                  paddle::platform::complex128>);
REGISTER_OP_SW_KERNEL(
    elementwise_add_grad_grad,
    ops::ElementwiseAddDoubleGradKernel<paddle::platform::SWDeviceContext,
                                        float>,
    ops::ElementwiseAddDoubleGradKernel<paddle::platform::SWDeviceContext,
                                        double>,
    ops::ElementwiseAddDoubleGradKernel<paddle::platform::SWDeviceContext,
