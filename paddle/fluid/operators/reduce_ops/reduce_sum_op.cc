...
REGISTER_OP_SW_KERNEL(
    reduce_sum, ops::ReduceKernel<paddle::platform::SWDeviceContext, float,
                                  ops::SumFunctor>,
    ops::ReduceKernel<paddle::platform::SWDeviceContext, double,
                      ops::SumFunctor>,
    ops::ReduceKernel<paddle::platform::SWDeviceContext, int, ops::SumFunctor>,
    ops::ReduceKernel<paddle::platform::SWDeviceContext, int64_t,
                      ops::SumFunctor>,
    ops::ReduceKernel<paddle::platform::SWDeviceContext,
                      paddle::platform::complex64, ops::SumFunctor>,
    ops::ReduceKernel<paddle::platform::SWDeviceContext,
                      paddle::platform::complex128,
...
template <typename T>
using SWReduceSumGradKernel =
    ops::ReduceSumGradKernel<paddle::platform::SWDeviceContext, T,
                             ops::SumGradFunctor, true>;                             
...
REGISTER_OP_SW_KERNEL(reduce_sum_grad, SWReduceSumGradKernel<float>,
                       SWReduceSumGradKernel<double>,
                       SWReduceSumGradKernel<int>,
                       SWReduceSumGradKernel<int64_t>,
                       SWReduceSumGradKernel<paddle::platform::complex64>,
                       SWReduceSumGradKernel<paddle::platform::complex128>);