...
REGISTER_OP_SW_KERNEL(reduce_mean,
...
template <typename T>
using SWReduceMeanGradKernel =
    ops::ReduceGradKernel<paddle::platform::SWDeviceContext, T,
                          ops::MeanGradFunctor, true>;

REGISTER_OP_SW_KERNEL(reduce_mean_grad, SWReduceMeanGradKernel<float>,
                       SWReduceMeanGradKernel<double>);
