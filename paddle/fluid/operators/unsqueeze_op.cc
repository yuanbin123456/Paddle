...
REGISTER_OP_SW_KERNEL(
    unsqueeze, ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, float>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, double>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, bool>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, int>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    unsqueeze_grad,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, float>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, double>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, bool>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, int>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::UnsqueezeGradKernel<paddle::platform::SWDeviceContext, int64_t>);
REGISTER_OP_SW_KERNEL(
    unsqueeze2, ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, float>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, double>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, bool>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, int>,
    ops::UnsqueezeKernel<paddle::platform::SWDeviceContext, uint8_t>,
...
REGISTER_OP_SW_KERNEL(
    unsqueeze2_grad,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, float>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, double>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, bool>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, int>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, uint8_t>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, int8_t>,
    ops::Unsqueeze2GradKernel<paddle::platform::SWDeviceContext, int64_t>);
