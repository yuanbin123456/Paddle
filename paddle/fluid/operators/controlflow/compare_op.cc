...
REGISTER_COMPARE_KERNEL(less_than, SW, paddle::operators::LessThanFunctor,
                        paddle::operators::GreaterEqualFunctor);
...
REGISTER_COMPARE_KERNEL(less_equal, SW, paddle::operators::LessEqualFunctor,
                        paddle::operators::GreaterThanFunctor);                        
...
REGISTER_COMPARE_KERNEL(greater_than, SW,
                        paddle::operators::GreaterThanFunctor,
                        paddle::operators::LessEqualFunctor);
...
REGISTER_COMPARE_KERNEL(greater_equal, SW,
                        paddle::operators::GreaterEqualFunctor,
                        paddle::operators::LessThanFunctor);                        
...
REGISTER_COMPARE_KERNEL(equal, SW, paddle::operators::EqualFunctor,
                        paddle::operators::EqualFunctor);                        
...
REGISTER_COMPARE_KERNEL(not_equal, SW, paddle::operators::NotEqualFunctor,
                        paddle::operators::NotEqualFunctor);
